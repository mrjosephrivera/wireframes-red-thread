      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center space-x-2">
            <div className="h-8 w-8 bg-red-800 rounded"></div>
          ...
          <div className="hidden lg:flex items-center space-x-8">
            <NavigationMenu>
              <NavigationMenuList className="space-x-6">
                {/* How We Help */}
                <NavigationMenuItem>
                  <NavigationMenuTrigger className="font-lato text-gray-700 hover:text-red-800">
                    How We Help
                  </NavigationMenuTrigger>
                  <NavigationMenuContent>
                    <div className="grid w-[600px] gap-3 p-6">
                      <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-3">
                          <h4 className="font-semibold font-playfair text-gray-900">Our Services</h4>
                          <NavigationMenuLink asChild>
                            <Link href="/how-we-help/write-together" className="block p-3 rounded-lg hover:bg-gray-50">
                              <div className="font-semibold font-lato text-red-800">WRITE Together</div>
                              <div className="text-sm text-gray-600 font-lato">Manuscript development & coaching</div>
                            </Link>
                          </NavigationMenuLink>
                          <NavigationMenuLink asChild>
                            <Link href="/how-we-help/publish-with-confidence" className="block p-3 rounded-lg hover:bg-gray-50">
                              <div className="font-semibold font-lato text-blue-800">PUBLISH with Confidence</div>
                              <div className="text-sm text-gray-600 font-lato">Full-service publishing</div>
                            </Link>
                          </NavigationMenuLink>
                          <NavigationMenuLink asChild>
                            <Link href="/how-we-help/grow-your-impact" className="block p-3 rounded-lg hover:bg-gray-50">
                              <div className="font-semibold font-lato text-teal-700">Grow your IMPACT</div>
                              <div className="text-sm text-gray-600 font-lato">Media training & thought leadership</div>
                            </Link>
                          </NavigationMenuLink>
                        </div>
                        <div className="space-y-3">
                          <h4 className="font-semibold font-playfair text-gray-900">Pricing</h4>
                          <NavigationMenuLink asChild>
                            <Link href="/pricing/packages" className="block p-3 rounded-lg hover:bg-gray-50">
                              <div className="font-semibold font-lato">Individual Packages</div>
                              <div className="text-sm text-gray-600 font-lato">Write, Publish, or Impact</div>
                            </Link>
                          </NavigationMenuLink>
                          <NavigationMenuLink asChild>
                            <Link href="/pricing/all-in-package" className="block p-3 rounded-lg hover:bg-gray-50">
                              <div className="font-semibold font-lato">All-in Package</div>
                              <div className="text-sm text-gray-600 font-lato">Complete publishing journey</div>
                            </Link>
                          </NavigationMenuLink>
                        </div>
                      </div>
                    ...
                    <div className="grid w-[500px] gap-3 p-6">
                      <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-3">
                          ...
                          <NavigationMenuLink asChild>
                            <Link href="/our-work/awards" className="block p-3 rounded-lg hover:bg-gray-50">
                              <div className="font-semibold font-lato">Awards</div>
                              <div className="text-sm text-gray-600 font-lato">Recognition & achievements</div>
                            </Link>
                          </NavigationMenuLink>
                        </div>
                        <div className="space-y-3">
                          <NavigationMenuLink asChild>
                            <Link href="/our-work/case-studies" className="block p-3 rounded-lg hover:bg-gray-50">
                              <div className="font-semibold font-lato">Case Studies</div>
                              <div className="text-sm text-gray-600 font-lato">Detailed success stories</div>
                            </Link>
                          </NavigationMenuLink>
                          <NavigationMenuLink asChild>
            ...
            <Button className="bg-red-800 hover:bg-red-900 font-lato" asChild>
            ...
            <div className="space-y-4 pt-4">
              <div className="space-y-2">
                ...
                <div className="pl-4 space-y-2">
                  <Link href="/how-we-help/write-together" className="block text-gray-600 font-lato">WRITE Together</Link>
                  <Link href="/how-we-help/publish-with-confidence" className="block text-gray-600 font-lato">PUBLISH with Confidence</Link>
                  <Link href="/how-we-help/grow-your-impact" className="block text-gray-600 font-lato">Grow your IMPACT</Link>
                  <Link href="/pricing/packages" className="block text-gray-600 font-lato">Pricing</Link>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="pl-4 space-y-2">
                  <Link href="/our-work/published-authors" className="block text-gray-600 font-lato">Published Authors</Link>
                  <Link href="/our-work/book-catalog" className="block text-gray-600 font-lato">Book Catalog</Link>
                  <Link href="/our-work/awards" className="block text-gray-600 font-lato">Awards</Link>
                  <Link href="/our-work/testimonials" className="block text-gray-600 font-lato">Testimonials</Link>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="pl-4 space-y-2">
                  <Link href="/resources/ebook" className="block text-gray-600 font-lato">Download eBook</Link>
                  <Link href="/resources/webinar-series" className="block text-gray-600 font-lato">Webinar Series</Link>
                  <Link href="/resources/community" className="block text-gray-600 font-lato">Community</Link>
                  <Link href="/resources/blog" className="block text-gray-600 font-lato">Blog</Link>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="pl-4 space-y-2">
                  <Link href="/about/our-story" className="block text-gray-600 font-lato">Our Story</Link>
                  <Link href="/about/meet-the-team" className="block text-gray-600 font-lato">Meet the Team</Link>
                  <Link href="/about/why-red-thread" className="block text-gray-600 font-lato">Why Red Thread</Link>
                </div>
              </div>

              <Button className="w-full bg-red-800 hover:bg-red-900 font-lato" asChild>
                <Link href="/get-started">Get Started</Link>
              </Button>
            </div>
          </div>
