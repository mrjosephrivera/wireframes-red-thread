                  ...
                  <div className="p-6">
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-3">
                        <h4 className="font-semibold font-playfair text-gray-900 border-b border-gray-200 pb-2">Our Services</h4>
                        <Link href="/how-we-help/write-together" className="block p-3 border border-gray-200 rounded hover:bg-gray-50">
                        ...
                        <Link href="/how-we-help/publish-with-confidence" className="block p-3 border border-gray-200 rounded hover:bg-gray-50">
                        ...
                        <Link href="/how-we-help/grow-your-impact" className="block p-3 border border-gray-200 rounded hover:bg-gray-50">
                      ...
                      <div className="space-y-3">
                        <h4 className="font-semibold font-playfair text-gray-900 border-b border-gray-200 pb-2">Pricing</h4>
                        <Link href="/pricing/packages" className="block p-3 border border-gray-200 rounded hover:bg-gray-50">
                        ...
                        <Link href="/pricing/all-in-package" className="block p-3 border border-gray-200 rounded hover:bg-gray-50">
              ...
              <div className="relative group">
                ...
                <div className="absolute top-full left-0 mt-2 w-80 bg-white border-2 border-gray-300 rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                  <div className="p-6 space-y-3">
                    <Link href="/our-work/published-authors" className="block p-3 border border-gray-200 rounded hover:bg-gray-50">
                    ...
                    <Link href="/our-work/book-catalog" className="block p-3 border border-gray-200 rounded hover:bg-gray-50">
                    ...
                    <Link href="/our-work/testimonials" className="block p-3 border border-gray-200 rounded hover:bg-gray-50">
              ...
              <div className="relative group">
                ...
                <div className="absolute top-full left-0 mt-2 w-80 bg-white border-2 border-gray-300 rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                  <div className="p-6 space-y-3">
                    ...
                    <Link href="/resources/webinar-series" className="block p-3 border border-gray-200 rounded hover:bg-gray-50">
                    ...
                    <Link href="/resources/community" className="block p-3 border border-gray-200 rounded hover:bg-gray-50">
              ...
              <div className="relative group">
                ...
                <div className="absolute top-full left-0 mt-2 w-80 bg-white border-2 border-gray-300 rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                  <div className="p-6 space-y-3">
                    ...
                    <Link href="/about/meet-the-team" className="block p-3 border border-gray-200 rounded hover:bg-gray-50">
                    ...
                    <Link href="/about/why-red-thread" className="block p-3 border border-gray-200 rounded hover:bg-gray-50">
            ...
            <div className="space-y-4 pt-4">
              <div className="space-y-2 p-4 border border-gray-300 rounded">
                ...
                <div className="pl-4 space-y-2">
                  <Link href="/how-we-help/write-together" className="block text-gray-600 font-lato py-1 border-l-2 border-gray-300 pl-3">WRITE Together</Link>
                  <Link href="/how-we-help/publish-with-confidence" className="block text-gray-600 font-lato py-1 border-l-2 border-gray-300 pl-3">PUBLISH with Confidence</Link>
                  <Link href="/how-we-help/grow-your-impact" className="block text-gray-600 font-lato py-1 border-l-2 border-gray-300 pl-3">Grow your IMPACT</Link>
                  <Link href="/pricing/packages" className="block text-gray-600 font-lato py-1 border-l-2 border-gray-300 pl-3">Pricing</Link>
                </div>
              </div>
              ...
              <div className="space-y-2 p-4 border border-gray-300 rounded">
                ...
                <div className="pl-4 space-y-2">
                  <Link href="/our-work/published-authors" className="block text-gray-600 font-lato py-1 border-l-2 border-gray-300 pl-3">Published Authors</Link>
                  <Link href="/our-work/book-catalog" className="block text-gray-600 font-lato py-1 border-l-2 border-gray-300 pl-3">Book Catalog</Link>
                  <Link href="/our-work/awards" className="block text-gray-600 font-lato py-1 border-l-2 border-gray-300 pl-3">Awards</Link>
                  <Link href="/our-work/testimonials" className="block text-gray-600 font-lato py-1 border-l-2 border-gray-300 pl-3">Testimonials</Link>
                </div>
              </div>
              ...
              <div className="space-y-2 p-4 border border-gray-300 rounded">
                ...
                <div className="pl-4 space-y-2">
                  <Link href="/resources/ebook" className="block text-gray-600 font-lato py-1 border-l-2 border-gray-300 pl-3">Download eBook</Link>
                  <Link href="/resources/webinar-series" className="block text-gray-600 font-lato py-1 border-l-2 border-gray-300 pl-3">Webinar Series</Link>
                  <Link href="/resources/community" className="block text-gray-600 font-lato py-1 border-l-2 border-gray-300 pl-3">Community</Link>
                  <Link href="/resources/blog" className="block text-gray-600 font-lato py-1 border-l-2 border-gray-300 pl-3">Blog</Link>
                </div>
              </div>
              ...
              <div className="space-y-2 p-4 border border-gray-300 rounded">
                ...
                <div className="pl-4 space-y-2">
                  <Link href="/about/our-story" className="block text-gray-600 font-lato py-1 border-l-2 border-gray-300 pl-3">Our Story</Link>
                  <Link href="/about/meet-the-team" className="block text-gray-600 font-lato py-1 border-l-2 border-gray-300 pl-3">Meet the Team</Link>
                  <Link href="/about/why-red-thread" className="block text-gray-600 font-lato py-1 border-l-2 border-gray-300 pl-3">Why Red Thread</Link>
                </div>
              </div>

              <Button className="w-full bg-gray-800 hover:bg-gray-900 text-white border-2 border-gray-700 font-lato" asChild>
                <Link href="/get-started">Get Started</Link>
              </Button>
            </div>
          </div>
